<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 border border-gray-200 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900">{{ $totalCountry }}</p>
                </div>
    ...
    <a href="{{ route('pakagedestinations.index') }}" class="block">
        <div class="bg-white rounded-lg shadow-sm p-6 border border-gray-200 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-gray-600">Total Packages</p>
                    <p class="text-3xl font-bold text-gray-900">{{ $totalPackageDestinations }}</p>
                </div>
    ...
    <!-- Card 4: Total Package Details -->
    <a href="{{ route('package-details.index') }}" class="block">
        <div class="bg-white rounded-lg shadow-sm p-6 border border-gray-200 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-gray-600">Total Package Details</p>
                    <p class="text-3xl font-bold text-gray-900">{{ $totalPackageDetinationDetails }}</p>
                </div>
