...
<div class="container py-4">
    <h4>Edit Package Destination Detail</h4>
    <form action="{{ route('package-details.update', $detail->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        @include('backend.packagedestinationdetails.form', ['edit' => true])
    </form>
</div>
@endsection
@section('scripts')
